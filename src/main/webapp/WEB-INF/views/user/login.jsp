...
<body class="bg-gradient-primary">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">WELECOME BACK</h1>
                  </div>
                  <form class="user" role="form" action="/bbs/user/loginPost" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="uid" placeholder="USER_ID" autofocus>
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="exampleInputPassword" name="upw" placeholder="PASSWORD">
                    </div>
                    <div class="form-group">
  ...
  <script src="/bbs/resources/sb-adminjs/sb-admin-2.min.js"></script>
